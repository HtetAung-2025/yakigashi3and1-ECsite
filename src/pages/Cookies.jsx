...
import cookies from "../images/home/cookie.jpg";
    ...
    <div>
      ...
      <section className="home" id="home">
        <div className="key-virtual container">
          <img src={cookies} alt="" className="kvimg" />
          <div className="kv-left">
            <div className="key-virtual-text">
              <h1>ロゴクッキー</h1>
              <p lang="en">Logo Cookies</p>
              <h1 lang="en">200¥ <span>（税込）</span></h1>
      ...
      <section className="product-information container">
        <h2>商品説明</h2>
        <h4>ロゴマークのレモンちゃんのクッキー</h4>
        <div className="info-sentence">
          <p>商品名</p>
          <p>ロゴクッキー(Logo Cookies)</p>
        </div>
        <div className="info-sentence">
          <p>名称</p>
          <p>焼き菓子</p>
