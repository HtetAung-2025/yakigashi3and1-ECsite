...
import nutcake from "../images/home/nutcake.jpg";
import {useCart} from "../pages/CartContext";

export default function Nutcake() {
    ...
    <div>
      ...
      <section className="home" id="home">
        <div className="key-virtual container">
          <img src={nutcake} alt="" className="kvimg" />
          <div className="kv-left">
            <div className="key-virtual-text">
              <h1>チョコナッツケーキ</h1>
              <p lang="en">Nut Cake</p>
              <h1 lang="en">330¥ <span>（税込）</span></h1>
      ...
      <section className="product-information container">
        <h2>商品説明</h2>
        <h4>瀬戸内の大三島の無農薬レモンをたっぷり使っています</h4>
        <div className="info-sentence">
          <p>商品名</p>
          <p>チョコナッツケーキ(Chocolate & nuts cake)</p>
        </div>
        <div className="info-sentence">
          <p>名称</p>
          <p>焼き菓子</p>
