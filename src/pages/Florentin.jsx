...
export default function Florentin() {
    ...
    <div>
      ...
      <section className="home" id="home">
        <div className="key-virtual container">
          <img src={florentin} alt="" className="kvimg" />
          <div className="kv-left">
            <div className="key-virtual-text">
              <h1>フロランタン</h1>
              <p lang="en">Florentin</p>
              <h1 lang="en">320¥ <span>（税込）</span></h1>
      ...
      <section className="product-information container">
        <h2>商品説明</h2>
        <h4>キャラメルアーモンドをサクサクのクッキーに乗せて焼き上げました</h4>
        <div className="info-sentence">
          <p>商品名</p>
          <p>フロランタン(Florentin)</p>
        </div>
        <div className="info-sentence">
          <p>名称</p>
          <p>焼き菓子</p>
